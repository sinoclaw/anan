...
This skill is designed for the Anan agent. It uses Anan tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Anan skills for specific phases:
