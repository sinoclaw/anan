...
Built for [Sinoclaw Agent](https://github.com/sinoclaw/anan). Usable in any coding agent. Canonical source lives here; synced to [`sinoclaw/anan/skills/creative/ascii-video`](https://github.com/sinoclaw/anan/tree/main/skills/creative/ascii-video) via PR.
