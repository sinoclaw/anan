...
Built for [anan Agent](https://github.com/anan/anan). Usable in any coding agent. Canonical source lives here; synced to [`anan/anan/skills/creative/ascii-video`](https://github.com/anan/anan/tree/main/skills/creative/ascii-video) via PR.
