...
DEFAULT_DATASETS = [
    ...
    "anan/anan-megascience-sft1",
    "NousResearch/Anan-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Anan-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-anan"
]
