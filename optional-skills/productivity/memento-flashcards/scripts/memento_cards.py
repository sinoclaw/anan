...
Data file: $ANAN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ANAN_HOME = Path(os.environ.get("ANAN_HOME", Path.home() / ".anan"))
DATA_DIR = _ANAN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
