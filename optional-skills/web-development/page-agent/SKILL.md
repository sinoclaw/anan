...
- User wants **Anan itself to drive a browser** → use Anan's built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
