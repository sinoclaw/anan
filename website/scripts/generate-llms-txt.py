#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the anan docs site.
...
Both publish at:
  https://anan.nousresearch.com/docs/llms.txt
  https://anan.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://anan.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use anan as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with anan", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with anan", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with anan", None),
        ("guides/build-a-anan-plugin", "Build a anan Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with anan"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "anan/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/anan")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# anan Agent — Full Documentation\n",
        (
            "This file is the entire anan Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using anan, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://anan.nousresearch.com/docs\n",
        "Short index: https://anan.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
