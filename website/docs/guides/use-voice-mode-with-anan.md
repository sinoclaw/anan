---
sidebar_position: 8
title: "Use Voice Mode with anan Agent"
description: "A practical guide to setting up and using anan Agent voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with anan Agent
...
- you want anan Agent sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in anan Agent.
...
## Step 1: make sure normal anan Agent works first
...
anan Agent supports both local and cloud speech stacks.
...
4. anan Agent transcribes and responds
...
- asking anan Agent to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full anan Agent loop.

## Tuning CLI behavior

### Silence threshold

If anan Agent starts/stops too aggressively, tune:
...
anan Agent stays a normal chat bot, but can speak replies.
...
- you want anan Agent to function like a portable research or ops assistant
...
- anan Agent detects speech boundaries
- transcripts are posted in the associated text channel
- anan Agent responds in text and audio
