...
You can still follow this tutorial using `deliver: "local"`. Briefings will be saved to `~/.anan/cron/output/` and you can read them anytime.
:::
...
---
3 stories • Sources searched: 8 • Generated by anan Agent
```
