...
sidebar_position: 7
title: "Email"
description: "Set up anan Agent as an email assistant via IMAP/SMTP"
---
...
- **A dedicated email account** for your anan agent (don't use your personal email)
...
| **Duplicate replies** | Ensure only one gateway instance is running. Check `anan gateway status`. |
...
- The password is stored in `~/.anan/.env` — protect this file (`chmod 600`)
