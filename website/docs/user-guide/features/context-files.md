...
Sinoclaw Agent automatically discovers and loads context files that shape how it behaves. Some are project-local and discovered from your working directory. `SOUL.md` is now global to the Hermes instance and is loaded from `ANAN_HOME` only.
...
| **SOUL.md** | Global personality and tone customization for this Hermes instance | `ANAN_HOME/SOUL.md` only |
...
- `~/.anan/SOUL.md`
- or `$ANAN_HOME/SOUL.md` if you run Hermes with a custom home directory
