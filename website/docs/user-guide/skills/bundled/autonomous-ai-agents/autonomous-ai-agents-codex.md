...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the anan Agent terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For anan Agent itself, `model.provider: openai-codex` uses anan-managed Codex
