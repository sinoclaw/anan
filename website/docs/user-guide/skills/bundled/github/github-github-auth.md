...
- Give it a title like "anan-&lt;machine-name>"
...
elif [ -f ~/.anan/.env ] && grep -q "^GITHUB_TOKEN=" ~/.anan/.env; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" ~/.anan/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
