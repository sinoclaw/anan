...
```python
import sys
sys.path.insert(0, "/home/teknium/.anan/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.anan/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — anan Agent installs package this)
