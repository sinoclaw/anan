...
Control the user's Spotify account via the anan Agent Spotify toolset (7 tools). Setup guide: https://anan.nousresearch.com/docs/user-guide/features/spotify
