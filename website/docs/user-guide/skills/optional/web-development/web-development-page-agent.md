...
- User wants **anan Agent itself to drive a browser** → use anan Agent's built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
