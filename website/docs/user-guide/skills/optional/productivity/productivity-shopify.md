...
| | |
|---|---|
| Source | Optional — install with `anan skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"anan Agent","productType":"Apparel","tags":["test"]}}'
```
