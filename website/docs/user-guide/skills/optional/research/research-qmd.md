...
| | |
|---|---|
| Source | Optional — install with `anan skills install official/research/qmd` |
...
anan Agent via the native MCP client. This is the preferred
...
Then configure anan Agent to connect via HTTP:
