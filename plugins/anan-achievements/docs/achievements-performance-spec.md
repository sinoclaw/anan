...
### `GET /api/plugins/anan-achievements/achievements`
...
### `POST /api/plugins/anan-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/anan-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/anan-achievements/overview`
...
- Persist plugin data under:
  - `~/.anan/plugins/anan-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.anan/plugins/anan-achievements/scan_checkpoint.json`
...
- `~/.anan/plugins/anan-achievements/`
