# Anan Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.anan/plugins/anan-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.anan/plugins/anan-achievements/scan_checkpoint.json`.
