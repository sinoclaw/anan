# Anan Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.anan/plugins/anan-achievements/state.json` (existing unlock state)
  - `~/.anan/plugins/anan-achievements/scan_snapshot.json` (new)
  - `~/.anan/plugins/anan-achievements/scan_checkpoint.json` (new)
