...
def _run_agent(
    ...
    # Imports are local so they don't run when anan is invoked for
    # other commands (keeps top-level CLI startup cheap).
    from anan_cli.config import load_config
    from anan_cli.models import detect_provider_for_model
    ...
    if effective_provider is None and (model or env_model):
        ...
        if explicit_model:
            ...
            try:
                from anan_cli import model_switch as _ms
