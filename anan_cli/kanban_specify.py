...
Used by ``anan kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``anan_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Anan Agent board.
...
def _profile_author() -> str:
    """Mirror of ``anan_cli.kanban._profile_author``. Kept local to
