"""
Skills configuration for Anan Agent.
`anan skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.anan/config.yaml under:
...
from anan_cli.config import cfg_get, load_config, save_config
from anan_cli.colors import Colors, color
from anan_cli.platforms import PLATFORMS as _PLATFORMS
