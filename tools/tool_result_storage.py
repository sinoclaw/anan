...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/anan-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/anan-results/{tool_use_id}.txt on Termux)
        ...
        if callable(get_temp_dir):
            try:
                ...
                if temp_dir:
                    ...
                    return f"{temp_dir}/anan-results"
    return STORAGE_DIR
