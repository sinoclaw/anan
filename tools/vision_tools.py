...
async def vision_analyze_tool(
    ...
    Note:
        - For URLs, temporary images are stored under $ANAN_HOME/cache/vision/ and cleaned up
    ...
    try:
        ...
        if local_path.is_file():
            ...
            temp_dir = get_anan_dir("cache/vision", "temp_vision_images")
...
async def video_analyze_tool(
    ...
    try:
        ...
        if local_path.is_file():
            ...
            if blocked:
                raise PermissionError(blocked["message"])
            temp_dir = get_anan_dir("cache/video", "temp_video_files")
