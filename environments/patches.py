"""
Monkey patches for making anan tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by anan_base_env.py).
