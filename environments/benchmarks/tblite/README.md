...
- **Dataset (ours):** [anan/openthoughts-tblite](https://huggingface.co/datasets/anan/openthoughts-tblite)
- **Docker images:** `anan/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `anan/terminal-bench-2`  | `anan/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
