"""
Email platform adapter for the Anan gateway.

Allows users to interact with Anan by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "anan Agent")
        ...
        msg_id = f"<anan-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
