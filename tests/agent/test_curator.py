...
def test_curator_slot_is_canonical_aux_task():
    ...
    from anan_cli.main import _AUX_TASKS
    from anan_cli.web_server import _AUX_TASK_SLOTS
    ...
    # 2. anan_cli/main.py _AUX_TASKS — CLI picker
    aux_keys = {k for k, _name, _desc in _AUX_TASKS}
    assert "curator" in aux_keys, "curator missing from _AUX_TASKS (CLI picker)"

    # 3. anan_cli/web_server.py _AUX_TASK_SLOTS — REST API allowlist
