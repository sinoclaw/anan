...
def _enable_managed_nous_tools(monkeypatch):
    ...
    anan_cli.auth and anan_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("anan_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("anan_cli.models.check_nous_free_tier", lambda: False)
