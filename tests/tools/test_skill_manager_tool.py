...
def _skill_dir(tmp_path):
    ...
    only the temp directory — not the real ~/.anan/skills/."""
...
class TestSecurityScanGate:
    ...
    def test_guard_flag_reads_config_default_false(self):
        ...
        with patch("anan_cli.config.load_config", return_value={"skills": {}}):
    ...
    def test_guard_flag_reads_config_when_set(self):
        ...
        with patch("anan_cli.config.load_config",
    ...
    def test_guard_flag_handles_config_error(self):
        ...
        with patch("anan_cli.config.load_config", side_effect=RuntimeError("boom")):
            assert _guard_agent_created_enabled() is False
...
class TestExternalSkillMutations:
    ...
    caused agents to create duplicate copies in ~/.anan/skills/ as a
    workaround.
    """
