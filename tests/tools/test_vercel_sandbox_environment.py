...
class TestFileSync:
    def test_initial_sync_uploads_managed_files_under_remote_home(
        ...
        assert uploaded == [
            {
                "path": "/home/vercel/.anan/credentials/token.txt",
    ...
    def test_cleanup_syncs_back_snapshots_closes_and_is_idempotent(
        ...
        vercel_sdk.current.download_file_content = _tar_bytes(
            {
                "home/vercel/.anan/credentials/token.txt": b"remote-token",
                "home/vercel/.anan/credentials/new.txt": b"new-remote",
                "home/vercel/.anan/unmapped/skip.txt": b"skip",
            }
        )
