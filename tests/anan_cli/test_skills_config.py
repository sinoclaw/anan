"""Tests for anan_cli/skills_config.py and skills_tool disabled filtering."""
import pytest
...
class TestSaveDisabledSkills:
    @patch("anan_cli.skills_config.save_config")
    def test_saves_global_sorted(self, mock_save):
        from anan_cli.skills_config import save_disabled_skills
        config = {}
...
class TestIsSkillDisabled:
    @patch("anan_cli.config.load_config")
...
class TestGetDisabledSkillNames:
    ...
    def test_anan_platform_takes_precedence(self, tmp_path, monkeypatch):
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from anan_cli.skills_config import _get_categories
        skills = [
