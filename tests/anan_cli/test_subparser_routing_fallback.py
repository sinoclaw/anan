...
The main() function in anan_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `anan -c model`
...
def _build_parser():
    """Build a minimal replica of the anan top-level parser."""
