"""Tests for the specifier module + `anan kanban specify` CLI surface.
...
from anan_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `anan kanban …` argparse surface directly."""
