...
import anan_cli.doctor as doctor
import anan_cli.gateway as gateway_cli
from anan_cli import doctor as doctor_mod
from anan_cli.doctor import _has_provider_env_config
...
class TestDoctorEnvFileEncoding:
    """Regression for #18637 (bug 3): `anan doctor` crashed on Windows
    ...
    def test_doctor_reads_env_as_utf8_even_when_locale_is_not_utf8(
        ...
        monkeypatch.setattr(doctor_mod, "ANAN_HOME", anan_home)
...
class TestDoctorMemoryProviderSection:
    ...
    def _make_anan_home(self, tmp_path, provider=""):
        """Create a minimal ANAN_HOME with config.yaml."""
        home = tmp_path / ".anan"
    ...
    def _run_doctor_and_capture(self, monkeypatch, tmp_path, provider=""):
        ...
        home = self._make_anan_home(tmp_path, provider)
...
class TestGitHubTokenCheck:
    ...
    def test_no_token_and_not_gh_authenticated_shows_warn(self, monkeypatch, tmp_path):
        ...
        from anan_cli.doctor import run_doctor, _DHH
        import io, contextlib
